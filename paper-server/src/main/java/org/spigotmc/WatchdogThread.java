...
public class WatchdogThread extends ca.spottedleaf.moonrise.common.util.TickThread { // Paper - rewrite chunk system
    ...
    private WatchdogThread(long timeoutTime, boolean restart) {
        super("CleanPaper Watchdog Thread");
        ...
        while (!this.stopping) {
            ...
            if (this.lastTick != 0 && this.timeoutTime > 0 && WatchdogThread.hasStarted && (!server.isRunning() || (currentTime > this.lastTick + this.earlyWarningEvery && !DISABLE_WATCHDOG))) { // Paper - add property to disable
                ...
                if (isLongTimeout) {
                    ...
                    logger.log(Level.SEVERE, "The server has stopped responding! This is (probably) not a CleanPaper bug."); // Paper
                    ...
                    logger.log(Level.SEVERE, "If you are unsure or still think this is a CleanPaper bug, please report this to https://github.com/Traveling-Trader/CleanPaper/issues");
                    logger.log(Level.SEVERE, "Be sure to include ALL relevant console errors and Minecraft crash reports");
                    logger.log(Level.SEVERE, "CleanPaper version: " + Bukkit.getServer().getVersion());
                    ...
                    logger.log(Level.SEVERE, "--- DO NOT REPORT THIS TO CLEANPAPER - THIS IS NOT A BUG OR A CRASH  - " + Bukkit.getServer().getVersion() + " ---");
                    logger.log(Level.SEVERE, "The server has not responded for " + (currentTime - lastTick) / 1000 + " seconds! Creating thread dump");
                }
                // Paper end - Different message for short timeout
                logger.log(Level.SEVERE, "------------------------------");
                logger.log(Level.SEVERE, "Server thread dump (Look for plugins here before reporting to CleanPaper!):"); // Paper
                ...
                if (isLongTimeout) {
                    ...
                    logger.log(Level.SEVERE, "--- DO NOT REPORT THIS TO CLEANPAPER - THIS IS NOT A BUG OR A CRASH ---");
                }

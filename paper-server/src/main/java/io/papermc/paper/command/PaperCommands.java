...
public final class PaperCommands {
    ...
    public static void registerCommands() {
        ...
        registerInternalCommand(PaperVersionCommand.create(), null, PaperVersionCommand.DESCRIPTION, List.of(), Set.of());
        registerInternalCommand(PaperPluginsCommand.create(), null, PaperPluginsCommand.DESCRIPTION, List.of(), Set.of());
    }
